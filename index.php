    ...
    <div class="container">
        <div class="wrapper">
            ...
            <form action="index.php" method="POST" class="p-3 mt-3">
                <div class="form-field d-flex align-items-center"> <span class="far fa-user"></span> <input type="text" name="userName" id="userName" placeholder="Usuário" autofocus> </div>
